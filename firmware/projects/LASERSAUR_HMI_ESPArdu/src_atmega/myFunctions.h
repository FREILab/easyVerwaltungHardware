...
//GPIO config
// Pins 0/1 sind Serial0 (USB-Debug via CH340) — nicht als GPIO verwenden!
// Pins 14/15 sind Serial3 (ESP8266-Kommunikation) — reserviert.
#define PIN_EEPROM_RESET 62  // A8 — war 0 (Serial0 RX, Konflikt)
#define PIN_LED          13  // OnBoard-LED — war 1 (Serial0 TX, Konflikt)
